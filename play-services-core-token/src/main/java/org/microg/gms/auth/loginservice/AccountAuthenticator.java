...
class AccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    public AccountAuthenticator(Context context) {
        ...
        this.accountType = org.microg.gms.tokenmanager.TokenGConstants.ACCOUNT_TYPE;
    }
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType,
        ...
        app = PackageUtils.getAndCheckPackage(context, app, options.getInt(KEY_CALLER_UID),
                options.getInt(KEY_CALLER_PID));
            ...
            if (res.auth != null) {
                ...
                try {
                    if (res.consentDataBase64 != null)
                        i.putExtra(AskPermissionActivity.EXTRA_CONSENT_DATA,
                                Base64.decode(res.consentDataBase64, Base64.URL_SAFE));
                } catch (Exception e) {
